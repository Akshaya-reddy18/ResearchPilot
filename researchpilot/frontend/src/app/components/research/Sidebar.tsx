import { Home, Upload, FolderKanban, Sparkles, LogOut } from 'lucide-react';
    ...
    <div className="w-64 h-screen bg-[#0a0e27] border-r border-indigo-900/30 flex flex-col">
      ...
      <div className="p-4 border-t border-indigo-900/30">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all text-sm"
        >
